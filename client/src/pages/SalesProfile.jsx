  ...
  return (
    <div className="min-h-screen space-y-6 bg-white pt-40 md:pt-48">
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
          ...
          <div className="mt-4 flex items-end gap-4">
            <div className="h-24 w-24 rounded-full bg-emerald-100 flex items-center justify-center">
              <span className="text-3xl font-semibold text-emerald-600">{employee.name.charAt(0)}</span>
            </div>
            <div>
        ...
        <section className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 grid gap-6 sm:grid-cols-3">
            <div className="rounded-2xl bg-emerald-50 p-4">
              <p className="text-sm text-slate-600">Sales Target</p>
              <p className="mt-2 text-3xl font-semibold text-emerald-600">TBD</p>
            </div>
        ...
        <section className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 space-y-3">
            <div className="flex items-center justify-between rounded-2xl bg-slate-50 p-3">
              <span className="font-medium text-slate-900">Active Accounts</span>
              <span className="rounded-full bg-emerald-100 px-3 py-1 text-sm font-semibold text-emerald-800">0</span>
            </div>
            <div className="flex items-center justify-between rounded-2xl bg-slate-50 p-3">
              <span className="font-medium text-slate-900">Client Retention Rate</span>
              <span className="text-sm text-slate-600">Tracking</span>
            </div>
            <div className="flex items-center justify-between rounded-2xl bg-slate-50 p-3">
              <span className="font-medium text-slate-900">Key Account Mgmt</span>
        ...
        {/* Sales Skills */}
        <section className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
          <h2 className="text-xl font-semibold text-slate-900">Sales Expertise</h2>
          <div className="mt-6">
            {employee.skills?.length > 0 ? (
              <div className="flex flex-wrap gap-2">
                {employee.skills.map((skill, idx) => (
                  <span
                    key={idx}
                    className="inline-flex rounded-full bg-emerald-100 px-3 py-1 text-sm font-medium text-emerald-800"
                  >
                    {skill}
                  </span>
                ))}
        ...
        <section className="rounded-3xl border border-gray-100 bg-white p-8 shadow-sm">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border-l-4 border-emerald-500 bg-emerald-50 p-4">
              ...
              <p className="text-sm text-slate-600">Core offering</p>
            </div>
            <div className="rounded-2xl border-l-4 border-emerald-500 bg-emerald-50 p-4">
              <p className="font-medium text-slate-900">Service Solutions</p>
              <p className="text-sm text-slate-600">Consulting</p>
            </div>
            <div className="rounded-2xl border-l-4 border-emerald-500 bg-emerald-50 p-4">
              <p className="font-medium text-slate-900">Enterprise Deals</p>
              <p className="text-sm text-slate-600">B2B focus</p>
            </div>
            <div className="rounded-2xl border-l-4 border-emerald-500 bg-emerald-50 p-4">
              <p className="font-medium text-slate-900">Customer Support</p>
              <p className="text-sm text-slate-600">Account management</p>
            </div>
          </div>
        </section>
