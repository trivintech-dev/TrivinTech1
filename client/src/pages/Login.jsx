      ...
      <div className="flex-1 flex items-start justify-center px-4 pb-12 pt-56 sm:px-6 lg:px-8 lg:pt-64">
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          ...
          <div className="bg-white rounded-3xl border border-gray-100 p-10 shadow-sm h-full flex flex-col justify-between">
            ...
            <p className="mt-2 text-sm text-gray-600">Sign in to access your dashboard and manage your services.</p>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-sm text-indigo-600 font-medium">Forgot password?</Link>
              </div>
            ...
            <div className="mt-6 space-y-3">
              <button type="button" onClick={handleGoogle} className="button-outline w-full">
                Continue with Google
              </button>
              <div className="text-center text-sm text-gray-600">Or continue with</div>
              <div className="flex gap-3">
                <button type="button" disabled className="flex-1 rounded-full border border-dashed border-gray-300 px-4 py-2 text-sm text-gray-400">
          ...
          <div className="px-2">
            <div className="rounded-2xl bg-gradient-to-br from-blue-900 to-blue-800 p-8 h-full flex flex-col justify-between text-blue-200">
              ...
              <div className="mt-6">
                <h3 className="text-xl font-semibold text-blue-100">Feature Highlights</h3>
                <ul className="mt-4 space-y-3">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="h-8 w-8 rounded-full bg-blue-500 text-white flex items-center justify-center">⚡</div>
                    <div>
                      <div className="font-medium text-blue-50">Realtime Updates</div>
                      <div className="text-sm text-blue-200">Live notifications for new applications and messages.</div>
                    </div>
                  </li>
                </ul>
              </div>

              <div className="mt-6 text-sm text-blue-200">Try the demo dashboard after signing in.</div>
            </div>
          </div>
        </div>
      </div>
